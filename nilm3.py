...
#create model
#############
model = NMF(n_components = len(appliances_value), init = 'random', alpha=0.01, l1_ratio = 1, max_iter=2000)
...
train_error = _beta_divergence(aggregate_signal,W_train,train.components_, beta = 2)
...
test_error = _beta_divergence(test_signal, W_test, train.components_, beta = 2)
